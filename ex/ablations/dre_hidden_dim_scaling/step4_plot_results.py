"""
Generate publication-quality visualizations comparing DRE methods
(TSM, TriangularMDRE, TriangularTDRE, MultiHeadTriangularTDRE)
...
config = yaml.load(open('ex/dre_hidden_dim_scaling/config.yaml', 'r'), Loader=yaml.FullLoader)

PROCESSED_RESULTS_DIR = config['processed_results_dir']
FIGURES_DIR = config['figures_dir']

HIDDEN_DIMS = config['hidden_dims']
ALGORITHMS = config.get('algorithms', ['TSM', 'TriangularMDRE', 'TriangularTDRE', 'MultiHeadTriangularTDRE'])

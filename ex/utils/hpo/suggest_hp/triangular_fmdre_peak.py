"""peak-extraction variant of TriangularFMDRE. N_STEPS bumped to 24300 to match
peak campaign max_resource. batch_size widened to [64, 128, 256, 512, 1024].

consider_pruned defaults to False: TriangularFMDRE uses triangular gamma path;
rung pruning introduces distribution-shift risk and may prune good hyperparams

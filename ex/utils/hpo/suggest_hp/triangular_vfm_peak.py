"""peak-extraction variant of TriangularVFM V1/V2/V3. N_STEPS bumped to 24300 to match
peak campaign max_resource. batch_size widened to [64, 128, 256, 512, 1024].

consider_pruned defaults to False: TriangularVFM uses multi-phase curriculum (triangular
schedule); rung pruning introduces distribution-shift risk and may prune good hyperparams
that simply struggle with partial-schedule supervision. conservative default: no pruning.
...
METADATA_V1 = {"uses_pruning": True, "requires_pstar": True, "builder": "build_TriangularVFM_V1", "consider_pruned": False}
METADATA_V2 = {"uses_pruning": True, "requires_pstar": True, "builder": "build_TriangularVFM_V2", "consider_pruned": False}
METADATA_V3 = {"uses_pruning": True, "requires_pstar": True, "builder": "build_TriangularVFM_V3", "consider_pruned": False}

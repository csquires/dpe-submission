...
parameters active in every training context (including the waypoint-builder
knobs midpoint_oversample / gamma_power / vertex, which flow through the
training data via TriangularWaypointBuilder1D). no conditional branching.

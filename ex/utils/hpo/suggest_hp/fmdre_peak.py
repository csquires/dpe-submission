"""peak-extraction variant of FMDRE. N_STEPS bumped to 24300 to match
peak campaign max_resource. batch_size widened to [64, 128, 256, 512, 1024].

consider_pruned defaults to False: FMDRE uses gamma annealing schedule;
rung-pruned trials may fail due to incomplete annealing rather than bad

...
class StudyConfig:
    ...
    Attributes:
        ...
        target_trials: per-study budget of COMPLETE (full-length) trials;
            the keeper stops dispatching once a study's COMPLETE count reaches
            it, and workers self-stop via MaxTrialsCallback. must > 0.

"""HPO config: pendulum -- gold-standard reproducer.

single tracked config covering every method we report on pendulum. running
this from an empty journal reproduces our full pendulum sweep end-to-end.
account- or campaign-specific subsets live in untracked sibling files
(e.g. pendulum_fillin.py).

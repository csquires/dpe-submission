"""HPO config: eig estimation -- gold-standard reproducer.

single tracked config covering every method we report on eig. running this
from an empty journal reproduces our full eig sweep end-to-end. account- or
campaign-specific subsets live in untracked sibling files (e.g. eig_fillin.py).

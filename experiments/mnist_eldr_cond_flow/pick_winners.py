"""
pick_winners.py (cond-flow): aggregate HPO trial results and select best per
...
def main():
    ...
    write YAML, print summary. defaults point at cond-flow paths."""
    parser = argparse.ArgumentParser(
        description="Select best HPO trials per (method, alpha) and write to YAML (cond-flow)"
    )

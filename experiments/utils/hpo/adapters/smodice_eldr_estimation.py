"""smodice gridworld ELDR estimation experiment adapter."""
import itertools
import os
...
_CONFIG_PATH = Path(__file__).resolve().parents[4] / "experiments/smodice_eldr_estimation/config.yaml"
...
class SmodiceAdapter(ExperimentAdapter):
    """smodice gridworld ELDR estimation adapter.
    ...
    def name(self) -> str:
        """return "smodice_eldr_estimation"."""
        return "smodice_eldr_estimation"
    ...
    def supports_tabular(self) -> bool:
        """return True — smodice has TabularPluginDRE methods."""
        return True

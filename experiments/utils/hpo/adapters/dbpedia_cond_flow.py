"""DBpedia ELDR conditional flow experiment adapter.
...
_CONFIG_PATH = _REPO_ROOT / "experiments/dbpedia_eldr_cond_flow/config.yaml"


class DbpediaCondFlowAdapter(ExperimentAdapter):
    """DBpedia ELDR conditional flow experiment adapter."""

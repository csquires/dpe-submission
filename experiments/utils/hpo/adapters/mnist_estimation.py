"""MNIST-ELDR estimation experiment adapter.
...
_CONFIG_PATH = _REPO_ROOT / "experiments/mnist_eldr_estimation/config.yaml"


class MnistEstimationAdapter(ExperimentAdapter):
    """MNIST-ELDR estimation experiment adapter."""

"""MNIST-ELDR conditional flow experiment adapter."""
import itertools
import h5py
import numpy as np
import torch
...
_CONFIG_PATH = _REPO_ROOT / "experiments/mnist_eldr_cond_flow/config.yaml"


class MnistCondFlowAdapter(ExperimentAdapter):
    """MNIST-ELDR conditional flow experiment adapter.
